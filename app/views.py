...
class ProductView(View):
	def get(self, request):
		totalitem = 0
		otherproducts = Product.objects.filter(category='OP')
		...
		return render(request, 'app/home.html', {'topwears':topwears, 'bottomwears':bottomwears, 'mobiles':mobiles, 'otherproducts':otherproducts, 'laptop':laptop, 'totalitem':totalitem })
...
def mobile(request, data=None):
	...
	if data==None :
			mobiles = Product.objects.filter(category='M')
	elif data == 'Redmi' or data == 'Samsung' or data == 'Xaomi':
...
def laptop(request, data=None):
	...
	if data==None :
			laptop = Product.objects.filter(category='L')
	elif data == 'DELL' or data == 'HP' or data == 'MSI':
